#!/bin/bash
# =============================================================================
# setup.sh — One-shot installer for netorch v1.2.0 on RHEL 9
#
...
info "[1/8] Installing system dependencies via dnf..."
...
info "[2/8] Creating '$SERVICE_USER' system user..."
id "$SERVICE_USER" &>/dev/null || \
    useradd --system --no-create-home --shell /sbin/nologin \
            --comment "netorch service account" "$SERVICE_USER"

# --- 3. Deploy files ---
info "[3/8] Deploying files to $INSTALL_DIR..."
mkdir -p "$INSTALL_DIR"
cp -r "$SCRIPT_DIR"/. "$INSTALL_DIR/"

# --- 4. Python venv ---
info "[4/8] Creating Python venv and installing dependencies..."
python3 -m venv "$VENV_DIR"
"$VENV_DIR/bin/pip" install --quiet --upgrade pip
"$VENV_DIR/bin/pip" install --quiet -r "$INSTALL_DIR/requirements.txt"

# --- 5. Directories and inventory ---
info "[5/8] Setting up inventory and log directories..."
...
# --- 7. Firewalld ---
info "[7/8] Opening port 64321/tcp in firewalld..."
...
[Unit]
Description=netorch Network Configuration Orchestrator v1.2.0
...
NoNewPrivileges=yes
ProtectSystem=full
ReadWritePaths=${INSTALL_DIR}/logs /var/netorch
...
echo ""
echo -e "${GREEN}======================================================"
echo " netorch v1.2.0 installed on RHEL 9"
echo -e "======================================================${NC}"
echo ""
